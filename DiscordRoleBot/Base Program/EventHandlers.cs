    ...
    internal partial class Bot
    {
        ...
        private static Task ClientUserJoinedEventHandler(SocketGuildUser user)
        {
            ...
            else
            {
                ...
                var quizURL = _config.GetValue(Type.GetType("System.String"), "QuizUrl").ToString();
                string message = $"Welcome to the Computer Science Discord. If you are one of our students, please ensure that you have submitted your Username and ID at {quizURL} which will give you permissions to use the server. Please note that your username is case sensitive. The process may take up to 2 hours to complete. If you have any problems, please get in touch with John Dixon (JDixonHull#1878) or David Parker (DavidParkerDr#6742).";
